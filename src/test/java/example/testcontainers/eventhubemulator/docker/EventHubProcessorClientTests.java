...
@SpringBootTest
@ActiveProfiles("docker-processor-client")
public class EventHubProcessorClientTests extends AbstractEventHubContainerDockerCompose {
    ...
    void processorClientTest() {
        ...
        EventProcessorClient eventProcessorClient = new EventProcessorClientBuilder()
                ...
                .processError(errorContext -> log.error("error processing event", errorContext.getThrowable()))
